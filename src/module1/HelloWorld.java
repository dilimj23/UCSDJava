...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// The next line zooms in and centers the map at 
	    // 38.9117756 (latitude) and -77.22327 (longitude)
	    //map2.zoomAndPanTo(zoomLevel, new Location(38.9117756f, -77.223270815f));
		
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, map2);
	    map2.zoomAndPanTo(zoomLevel, new Location(38.916009f, -77.223970f));
